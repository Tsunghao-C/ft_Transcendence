...
export async function setLobbyView(contentContainer, roomID = "") {
	...
	contentContainer.innerHTML = `
		<div class="gamelobby-view">
			<div id="game-lobby" class="gamelobby-view">
                ...
                <p id="rejoin-prompt-text">${trsl[state.language].onGoingGame}</p>
                <p id="rejoin-abort-text">${trsl[state.language].gameAborted}</p>
                <p id="rejoin-alreadyingame-text">${trsl[state.language].alreadyInGame}</p>
                <button id="rejoin-true-button">${trsl[state.language].rejoinGame}</button>
                <button id="rejoin-false-button">${trsl[state.language].concedeGame}</button>
    ...
    hideElem('rejoin-abort-text');
    hideElem('rejoin-alreadyingame-text');
    hideElem('rejoin-true-button');
    hideElem('rejoin-false-button');
